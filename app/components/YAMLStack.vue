...
<template>
  <div class="bg-zinc-800 dark:bg-black p-4 sm:p-6 border border-zinc-700 dark:border-zinc-800 rounded-2xl
    ...
    <div
      class="absolute top-2 sm:top-3 right-2 sm:right-3 text-[7px] sm:text-[8px] font-extrabold uppercase tracking-widest text-zinc-400 pointer-events-none">
      stack.yml
    </div>

    <pre class="mt-6 sm:mt-8 text-[10px] sm:text-[12px] leading-relaxed overflow-x-auto"><code class="font-mono text-zinc-300">
<span class="text-green-400 font-bold">stack</span>:
  ...
  <span class="text-green-400">{{ t('tech_stack.frameworks') }}</span>:
    <span class="text-zinc-200">- Laravel</span>
    <span class="text-green-400">- Nuxt [MID]</span>
    <span class="text-zinc-200">- Tailwind</span>

  <span class="text-green-400">{{ t('tech_stack.infrastructure') }}</span>:
    <span class="text-green-400">- Docker</span>
    <span class="text-zinc-200">- Nginx</span>
    <span class="text-zinc-200">- MySQL/MariaDB</span>
    <span class="text-zinc-300">- GitHub Actions</span>

<span class="text-zinc-400 italic">{{ t('tech_stack.end_config') }}</span>
  </code></pre>
