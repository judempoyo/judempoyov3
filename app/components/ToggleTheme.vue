...
<template>
  ...
  >
    ...
    <!-- Curseur animé -->
    <div
      class="absolute inset-y-1 w-[38px] bg-primary transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] rounded-md flex items-center justify-center shadow-md dark:shadow-sm z-10"
