      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-20">
        <div class="lg:col-span-8 space-y-8">
          <div class="space-y-4">
            ...
            <h2
              class="text-lg md:text-4xl font-extrabold tracking-tight text-zinc-900 dark:text-zinc-100 cursor-help"
          ...
          <div
            class="space-y-4 text-sm md:text-base leading-relaxed text-zinc-700 dark:text-zinc-400"
          >
            <p>{{ t("about.bio_1") }}</p>
            <p>{{ t("about.bio_2") }}</p>
            <p>{{ t("about.bio_3") }}</p>
          ...
          >
            <h3
              class="text-xs font-black uppercase tracking-widest text-zinc-500 dark:text-zinc-600 mb-4"
            >
              {{ t("about.specs.title") }}
            </h3>

            <div
              class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs sm:text-[11px] md:text-xs font-mono"
            >
          ...
          <div class="sticky top-24">
            ...
            >
              <div class="flex items-center justify-between mb-4">
                <h3
                  class="text-xs font-black uppercase tracking-widest text-zinc-500 dark:text-zinc-600"
                >
                  {{ t("journey.title") }}
                </h3>
                <span
