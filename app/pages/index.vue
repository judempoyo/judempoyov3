...
useHead({
  title: "Jude Mpoyo | Backend Systems Engineer",
  meta: [
    {
      name: "description",
      content:
        "Full-stack PHP developer (Expert) transitioning to Go, Docker and Cloud/DevOps.",
    },
  ],
});
</script>
  ...
  <div class="font-mono">
    ...
    >
      ...
      <div class="container mx-auto max-w-[1400px] px-4 sm:px-6">
        <div
          class="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-20 items-start lg:items-center"
        >
          <div class="lg:col-span-8 space-y-4 lg:space-y-6 relative z-10">
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-center gap-4 py-3">
                <div
                  class="h-0.5 w-20 bg-gradient-to-r from-green-600 to-transparent dark:from-green-400"
                ></div>
                <span
                  class="text-xs font-black uppercase tracking-[0.4em] text-zinc-500 dark:text-zinc-400"
                >
            ...
            <div class="space-y-4">
              <p
                class="text-sm md:text-base lg:text-lg leading-relaxed font-medium text-zinc-700 dark:text-zinc-300"
              >
          ...
          <div class="lg:col-span-4 relative mt-8 lg:mt-0">
            ...
            <div
              class="absolute -bottom-4 -left-4 bg-green-600 dark:bg-green-400 px-3 py-1.5 shadow-xl rotate-[-2deg]"
            >
              <span
                class="text-[10px] text-white dark:text-zinc-900 italic uppercase tracking-widest"
              >
