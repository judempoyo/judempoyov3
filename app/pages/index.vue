...
<template>
  <div class="font-mono">
    ...
    >
      ...
      <div class="container mx-auto max-w-350 px-4 sm:px-6">
        <div
        ...
        >
          <div class="lg:col-span-8 space-y-4 lg:space-y-6 relative z-10">
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-center gap-4 py-3">
                <div
                  class="h-0.5 w-20 bg-linear-to-r from-green-600 to-transparent dark:from-green-400"
                ></div>
                <span
          ...
          <div class="lg:col-span-4 relative mt-8 lg:mt-0">
            ...
            <div
              class="absolute -bottom-4 -left-4 bg-green-600 dark:bg-green-400 px-3 py-1.5 shadow-xl -rotate-2"
            >
              <span
                class="text-[10px] text-white dark:text-zinc-900  uppercase tracking-widest"
              >
